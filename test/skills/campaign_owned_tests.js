...
const campaignOwned = require('../../src/skills/campaign_owned.js');
const ownedController = require('../../src/skillsControllers/owned_controller.js');


describe('campaign owned', () => {
  ...
  beforeEach(() => {
    ...
    jsforceConn = {};
    campaignOwned(controller, jsforceConn);
  ...
  it('should register hear listener on controller', () => {
    ...
    expect(controller.hears.args[0][0]).to.deep.equal(['campaign owned']);
